        ...
        <div>
            ...
            <div className="mt-2">
                <input id={id} type={type} autoComplete={id} disabled={disabled} {...register(id, {required})}
                    className={clsx(`form-input block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm 
                        ring-1 ring-inset ring-gray-300 placeholder:tecxt-gray-400 focus:right-2 focus:ring-inset 
